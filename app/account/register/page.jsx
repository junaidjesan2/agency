...
import signup from "../../../public/banner/signup.jpg";
import { useFormik } from "formik";
import * as Yup from "Yup";

const FormSchema = Yup.object().shape({
  fName: Yup.string().min(3).max(23).required("Please enter your First Name"),
  ...
  const { values, errors, handleSubmit, handleChange, handleBlur } = useFormik({
    ...
    onSubmit: (values) => {
      if (values.email!=="") {
        ...
        localStorage.setItem("registerValue",JSON.stringify(setvalue));
