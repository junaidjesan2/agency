    ...
    <footer className="w-full text-gray-700 bg-white body-font">
      <div className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
          ...
          <p className="mt-2 text-3xl text-gray-500">Design, Code and Ship!</p>
          <div className="mt-4">
        ...
        <div className="grid grid-cols-2 md:flex mt-10 mx-auto mb-10 text-center md:pl-20 md:mt-0 md:text-left">
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
            <h2 className="mb-3 text-2xl font-medium tracking-widest text-gray-900 uppercase title-font">
              About
            </h2>
